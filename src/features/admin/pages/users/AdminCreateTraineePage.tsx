...
import { createTraineeByAdmin } from '../../services/adminUserService'
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-400">
          Formu doldurarak yeni öğrenci kaydı açın; giriş bilgileri oluşturulduktan sonra
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr,minmax(0,320px)]">
        ...
        >
          ...
          >
            {mutation.isPending ? 'Gönderiliyor…' : 'Öğrenci oluştur'}
          </button>
        </form>
